...
lint: ## check style with flake8
	flake8 blackjack_simulator tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source blackjack_simulator -m pytest

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/blackjack_simulator.rst
	rm -rf docs/modules
	sphinx-apidoc -o docs/modules blackjack_simulator
	$(MAKE) -C docs -e clean
	$(MAKE) -C docs -e html
